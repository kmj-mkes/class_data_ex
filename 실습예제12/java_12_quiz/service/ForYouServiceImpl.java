package java_12_quiz.service;

import java.util.Scanner;

import java_12_quiz.dao.ForYouDAO;
...
public class ForYouServiceImpl implements ForYouService {
	...
	public void solutionBook() {
		...
		// 고민해결책의 답 가져오기
		String result = forYouDAO.selectSolutionBook("solution");
	...
	public void fortuneBook() {
		...
		// 고민해결책의 답 가져오기
		String result = forYouDAO.selectSolutionBook("fortune");
